...
%% \usepackage{fullpage}
% FONTS
% Define a helper macro to run shell commands and print the output
\makeatletter
\newcommand{\executecl}[1]{\@@input|"#1"}
\makeatletter
...
\newsectionwidth{1.1in} % Change '1.5in' to your preferred width
...
%% Journals: \executecl{grep -c bibentry journal.tex} \\
%% Conference proceedings: \executecl{grep -c bibentry conference.tex} \\
...
effort to assess the possible spread of Fall armyworm in Egypt (USAID-Egypt funded).
\end{enumerate}

%%
\section{\textnormal{\textsc{Selected Talks}}} 
\begin{enumerate}[1.]
\item (\textbf{Panel}) AI for Biosecurity and Agricultural Resilience, AI + the Environment Workshop, UVA, Charlottesville, May~2026.
...
%%
\clearpage
\moveleft1.0\hoffset\centerline{\large\bf Abhijin Adiga (Full CV)\hfill} % Your name at the top
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip % Horizontal line after name; adjust line thickness by changing the '1pt'
%%%%%%
...
\item USAID IPM Innovation Labs: \emph{A High-resolution Interaction Based Approach to Modeling the Spread of Agricultural Invasive Species},
...
\begin{enumerate}[$\circ$]
\item Identifying hidden illicit actors in financial networks by analyzing their neighborhood
 selected to appear in the Association for Computing Machinery (ACM) Showcase on Kudos.
...
\section{\textnormal{\textsc{Team science}}}
...
Nibir Chandra Mandal (Thesis committee) (Fall'24--) (Adviser: Madhav Marathe),\\
...
Julia Chen (Summer'26),
Tommy Guo (Summer'26),
Kyle Luong (Summer'26--) (Co-advisers: Madhav Marathe and S.~S.~Ravi),
...
Penina Waghalter (Summer'21) (Yeshiva University),
...
IJCAI AI and Social Good~(2025), KDD Data
